...
const DEFAULT_SKILLS = [
  { name: "JavaScript", color: "#cca87a" },
  { name: "TypeScript", color: "#9ba897" },
  { name: "Python", color: "#b89576" },
  { name: "HTML5", color: "#bda695" },
  { name: "CSS3", color: "#d1c7bd" },
  { name: "React", color: "#dfcca7" },
  { name: "Next.js", color: "#e8e2d5" },
  { name: "Node.js", color: "#81917b" },
  { name: "Rust", color: "#cca87a" },
  { name: "C++", color: "#b3a492" },
  { name: "WebGL", color: "#b89576" },
  { name: "Three.js", color: "#9ba897" },
  { name: "Canvas 2D", color: "#dfcca7" },
  { name: "TailwindCSS", color: "#81917b" },
  { name: "Docker", color: "#d1c7bd" },
  { name: "Git", color: "#bda695" },
  { name: "GraphQL", color: "#cca87a" },
  { name: "PostgreSQL", color: "#9ba897" },
  { name: "AWS", color: "#b89576" },
  { name: "API Design", color: "#81917b" },
  { name: "UI/UX", color: "#dfcca7" },
];
